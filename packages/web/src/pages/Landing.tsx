...
export function LandingPage() {
  ...
  useSEO({
    ...
    description:
      "Accede a listados actualizados de propietarios que venden sin intermediarios. Contactos directos, gestión de captaciones y notificaciones por zona. Herramienta profesional para agentes inmobiliarios.",
    ...
    <div className="min-h-screen overflow-x-hidden bg-surface-light dark:bg-surface-dark">
      ...
      <main>
        ...
        <section
          ...
          className="mx-auto max-w-7xl px-4 py-12 sm:py-20 sm:px-6 lg:px-8"
        >
          <div className="text-center">
            <h1
              id="hero-heading"
              className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-5xl md:text-6xl"
            >
              Captación de{" "}
              <span className="text-primary">propietarios particulares</span>{" "}
              para agentes inmobiliarios
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
              Accede a listados actualizados de propietarios que venden sin
              intermediarios. Contactos directos, gestión de estados y
        ...
        <section
          ...
          className="border-t border-border-light bg-white py-12 sm:py-20 dark:border-border-dark dark:bg-card-dark"
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ¿Cómo funciona la captación de particulares?
            </h2>
              ...
              {[
                {
                  ...
                  description:
                    "Elige las zonas que te interesan y accede a listados actualizados de propietarios que venden sin intermediarios.",
                  icon: (
                    <svg
                      className="h-6 w-6"
                      fill="none"
        ...
        <section
          ...
          className="border-t border-border-light py-12 sm:py-20 dark:border-border-dark overflow-hidden"
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid min-w-0 items-center gap-8 sm:gap-12 lg:grid-cols-2">
              ...
              <div className="hidden min-w-0 lg:block">
                ...
                <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">
                  Recibe alertas por email cada vez que se actualicen tus
                  listas. Sin tener que estar pendiente — te avisamos cuando hay
                  novedades.
                </p>
        ...
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h2
              ...
              className="text-center text-2xl font-bold text-slate-900 dark:text-white sm:text-3xl"
            >
              Lo que dicen los agentes inmobiliarios que usan InmoCapt
            </h2>
        ...
        <section
          ...
          className="bg-primary py-12 sm:py-20"
        >
          <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            ...
            >
              Empieza a captar propietarios particulares hoy
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-lg text-white/90">
              Únete a agentes inmobiliarios que ya triplicaron sus captaciones
              con InmoCapt.
            </p>
            <Button
              size="lg"
